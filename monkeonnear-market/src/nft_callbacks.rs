...
impl NonFungibleTokenApprovalsReceiver for Contract {
    fn nft_on_approve(
        ...
        //let nft_contract_id_event: String = nft_contract_id.to_string();
        //let token_id_event: String = token_id.to_string();
        //let owner_id_event: String = owner_id.to_string();
        ...
        if market_type == "sale" {
            ...
            /*NearEvent::log_nft_on_approve(
                token_id_event.to_string(),
                owner_id_event.to_string(),
                approval_id.clone(),
                nft_contract_id_event,
                price.unwrap(),
            );*/
